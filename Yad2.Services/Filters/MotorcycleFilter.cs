...
{
  public  class MotorcycleFilter: IFilterObject<Motorcycle>
    {
       ...
       // public int? GearType { get; set; }
        ...
        public IEnumerable<Motorcycle> Filter(IEnumerable<Motorcycle> allItems)
        {
            //validation:
            ...
            IEnumerable<Motorcycle> filteredCars = null;
