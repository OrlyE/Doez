...
{
    public class CarsFilter : IFilterObject<Car>
    {
        ...
        public IEnumerable<Car> Filter(IEnumerable<Car> allItems)
        {
            //validation:
            ...
            { // advanced filter
                filteredCars = allItems.Where(c =>
                 ...
                 && (!Model.HasValue || c.ModelId == Model.Value)
                  ...
                  &&(!OwnershipType.HasValue || c.OwnershipType == OwnershipType.Value)
                  && (!EngineCapacity.HasValue || c.EngineCapacity == EngineCapacity.Value)
